 ...
 * This file contains comprehensive API documentation using OpenAPI 3.0 specification
 */
 ...
 *     description: Returns paginated list of products with optional search, filter, and sort
 *     tags: [Products]
 *     parameters:
 *       - in: query
 *         name: page
 ...
 *     description: Returns complete product details by ID
 *     tags: [Products]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *                 type: string
 *                 minLength: 10
 *                 example: Product description with at least 10 characters
 ...
 *                 minimum: 0
 *                 example: 100
 *                 description: Stock quantity (non-negative integer)
 *               category:
 *                 type: string
 *                 example: Electronics
 ...
 *     description: Returns paginated list of orders (legacy endpoint)
 *     tags: [Orders]
 *     security:
 *       - bearerAuth: []
 *     parameters:
